...
def main():
    ...
    if args.configCode == 1150:  # split 0
        args.seed = 1150
    ...
    elif args.configCode == 7337:  # split 1
        args.seed = 7337
        args.optimizer_args["SGD"]["lr"] = 0.1
        args.optimizer_args["SGD"]["weight_decay"] = 0.0004
        args.scheduler_args["cosine"]["max_epoch"] = 20
        args.scheduler_args["cosine"]["warm_up"] = 5
    elif args.configCode == 2561:  # split 2
        args.seed = 2561
        args.optimizer_args["SGD"]["lr"] = 0.1
    ...
    #     -------------------------------------
    elif args.configCode == 5373:  # split 2
        args.seed = 5373
        args.optimizer_args["SGD"]["lr"] = 0.05
    ...
    elif args.configCode == 5374:  # split 2
        args.seed = 5374
        args.optimizer_args["SGD"]["lr"] = 0.05
        args.optimizer_args["SGD"]["weight_decay"] = 0.0005
    ...
    elif args.configCode == 7470:  # split 2
        args.seed = 7470
        args.optimizer_args["SGD"]["lr"] = 0.1
        args.optimizer_args["SGD"]["weight_decay"] = 0.0002
        args.scheduler_args["cosine"]["max_epoch"] = 30
        args.scheduler_args["cosine"]["warm_up"] = 5

    elif args.configCode == 7456:  # split 2
        args.seed = 7456
        args.optimizer_args["SGD"]["lr"] = 0.05
        args.optimizer_args["SGD"]["weight_decay"] = 0.0003
        args.scheduler_args["cosine"]["max_epoch"] = 60
        args.scheduler_args["cosine"]["warm_up"] = 10
    elif args.configCode == 4059:  # split 2
        args.seed = 4059
        args.optimizer_args["SGD"]["lr"] = 0.05
    ...
    elif args.configCode == 8642:  # split 2
        args.seed = 8642
        args.optimizer_args["SGD"]["lr"] = 0.05
        args.optimizer_args["SGD"]["weight_decay"] = 0.0005
        args.scheduler_args["cosine"]["max_epoch"] = 70
    ...
    elif args.configCode == 3082:  # split 2
        args.seed = 3082
        args.optimizer_args["SGD"]["lr"] = 0.1
        args.optimizer_args["SGD"]["weight_decay"] = 0.0001
        args.scheduler_args["cosine"]["max_epoch"] = 30
    ...
    elif args.configCode == 9954:  # split 2
        args.seed = 9954
        ...
        args.scheduler_args["cosine"]["warm_up"] = 0
        args.dataset_args[args.dataset]["train_batch_size"] = 8
    elif args.configCode == 53742:  # split 2
        args.seed = 5374
        args.optimizer_args["SGD"]["lr"] = 0.05
        args.optimizer_args["SGD"]["weight_decay"] = 0.0005
        args.scheduler_args["cosine"]["max_epoch"] = 50
    ...
    elif args.configCode == 1478:  # split 2
        args.seed = 1478
        args.optimizer_args["SGD"]["lr"] = 0.05
        args.optimizer_args["SGD"]["weight_decay"] = 0.0002
        args.scheduler_args["cosine"]["max_epoch"] = 50
    ...
    if args.generate_data:
        ...
        logging.basicConfig(filename='./tunefiles/files0527_softnode3/txt0525_{}_{}_{}_{}_{}_{}.log'.format(
            ...
            datefmt=DATE_FORMAT,
            filemode="w")
        logging.info("0527: 旨在重新生成最优参数文件，修复Saving model的代码位置！参数文件将放置在 resource0527")
        p = Processor(args)
        p.start()
...
def init_parser():
    ...
    parser.add_argument('--granularity', '-granularity', type=str, default="action", help='tcr')
