...
class Graph():
    ...
    def _get_edge(self):
        if self.dataset == 'kinetics':
            ...
            neighbor_link = [(i - 1, j - 1) for (i, j) in neighbor_1base]
            connect_joint = np.array(
                [9, 1, 2, 3, 9, 5, 6, 7, 10, 10, 10, 11, 12, 13, 12, 15, 16, 17, 18, 17, 12, 21, 22, 23, 24, 23]) - 1
            parts = [
        ...
        elif self.dataset == '3mdad' or "3mdad_downsampled" in self.dataset or self.dataset == "dad" or str(
